...
public class Registrar {
     ...
     */
    public Registrar(){
        StudentLoader sl = new StudentLoader("Preregistration-Part1-starter/data/shortRoster.csv");
        List<Student> students = sl.getStudents();
        
        CourseLoader cl = new CourseLoader("Preregistration-Part1-starter/data/course_shortRequests.csv");
